...
- Inflación oficial: El INEGI reporta inflación del 4.66% anual, pero la inflación real percibida en productos básicos suele ser mayor (6-8% en alimentos, gasolina, educación).
...
**Cuentas de ahorro básicas:** rendimiento promedio 0.5%-1.5% anual vs inflación de 4.66% anual = pérdida neta de -3% a -4% de poder adquisitivo anual.

**Pagarés bancarios y plazos fijos:** rendimiento 8%-10% anual (plazos 28-90 días), ganancia neta real +3% a +5% anual. Desventaja: dinero bloqueado, penalización por retiro anticipado.
...
**Comparativa efectivo vs oro (2020-2025):** $100,000 pesos en efectivo → poder adquisitivo de $77,000 (pérdida -23%). $100,000 pesos convertidos a oro → valor aproximado de $138,000 hoy (ganancia +38%). Diferencia neta: $61,000 pesos de protección.
...
**Bitcoin y Ethereum:** potencial de crecimiento alto (Bitcoin +120% en 2023), descentralización total; pero volatilidad extrema (caídas del 30-50% en semanas son comunes), riesgo tecnológico, curva de aprendizaje alta. Adecuado para perfil especulativo con alta tolerancia al riesgo.

**Stablecoins (USDT, USDC):** estabilidad al estar atadas al dólar, liquidez inmediata, rendimientos 5-8% en plataformas DeFi; pero riesgo de plataforma (hackeos) y no protegen contra inflación del dólar. Adecuado para dolarización digital de ahorros.
...
**Acciones individuales:** rendimiento potencial 10%-30% anual en empresas sólidas, pero volatilidad alta y riesgo empresarial. Requiere análisis constante y estómago para caídas del 20-40%.

**ETFs (fondos cotizados):** rendimiento histórico 8%-12% anual (índices diversificados como S&P 500), con diversificación automática. Desventaja: comisiones de administración.
...
**Ventajas:** protección natural contra inflación, generación de ingresos pasivos (rentas), activo tangible con valor intrínseco.

**Desventajas críticas:** capital inicial masivo (mínimo $500,000-$1,000,000+ MXN), liquidez bajísima (vender toma 3-12 meses), costos de mantenimiento (predial, mantenimiento, seguros: 2-5% del valor anual), riesgo de vacancia.
...
**Efectivo físico en dólares:** control directo sin intermediarios; pero riesgo de robo, no genera rendimientos, sigue expuesto a inflación estadounidense (3-4% anual).

**Cuenta bancaria en dólares:** seguridad y liquidez; pero rendimientos casi nulos (0.1-0.5% anual) y comisiones por manejo de cuenta.

**Inversiones en dólares (bonos del Tesoro USA):** rendimiento 4.5%-5.5% anual, respaldo del gobierno estadounidense; pero requiere plataforma internacional y comisiones de conversión.

Los dólares protegen contra devaluación del peso (-12.4% últimos 5 años) pero NO contra inflación global. El oro protege contra ambos. Resultado neto últimos 5 años: oro +38% vs dólar +12% (en pesos mexicanos).

**Veredicto:** los dólares son mejor que pesos sin protección, pero el oro ofrece doble protección: contra devaluación del peso y contra inflación del dólar.
...
Depende de tu definición de "segura". Para capital garantizado: CETES (10% anual). Para preservación de valor real: oro. Para crecimiento: ETFs diversificados (con más volatilidad).

**¿Puedo combinar varias alternativas al efectivo?**

Absolutamente, es lo más recomendable. Una cartera balanceada podría incluir: 35% oro, 30% acciones/ETFs, 25% CETES/pagarés, 10% efectivo.

**¿El oro es mejor que los dólares para proteger ahorros?**

Para protección completa, sí. Los dólares solo protegen contra devaluación del peso, pero siguen expuestos a inflación estadounidense. El oro protege contra ambos.
...
Las criptomonedas volátiles son activos especulativos, no alternativas conservadoras. Las stablecoins funcionan como dolarización digital pero con riesgos técnicos. Para protección sin volatilidad extrema, el oro es superior.

**¿Necesito conocimientos financieros para buscar alternativas al efectivo?**

No necesariamente. Las opciones más simples (oro fraccionado, CETES, pagarés) son accesibles sin conocimientos avanzados.
